...
- The GitHub Stats Extended core is vendored in this repository and fixed by `pnpm-lock.yaml`; this fork does not download a renderer at runtime. The vendored package was built from [`JWMatheo/github-stats-extended@33a9c63c`](https://github.com/JWMatheo/github-stats-extended/commit/33a9c63ca6966ad8a14bb5faeca1a99891e2dd53).
